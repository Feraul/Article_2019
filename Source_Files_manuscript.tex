...
\title{Acceleration Strategies for Non-Linear Finite Volume Positive-Preserving for Diffusion Problems in Anisotropic and Heterogeneous Media}
...
In this section, we present the numerical formulation of our non-orthodox Multipoint Flux Approximation Method (MPFA-QL), using the interpolation strategy proposed by Gao and Wu \cite{gao2011linearity}. 
...
Equation \ref{eq10} (with Eq. \ref{eq11}) is also called, convex descomposition of the co-normal. This decomposition is necessary in constructing non-linear positive-preserving schemes (\cite{le2005finite}, \cite{lipnikov2007monotone}, \cite{yuan2008monotone},\cite{gao2013small}). The physical-geometric parameters in Eq. \ref{eq11} are calculated following a geometric procedure. In fact, we can write:
\begin{equation}\label{eq12}
| {{\alpha }_{\hat{L},j(IJ)}}|=\frac{\left| {{{\utilde{K}}}_{\hat{L}}^\top}{{{\vec{n}}}_{IJ}}\times {{\overrightarrow{{{x}_{{\hat{L}}}}x}}_{\hat{L},i(IJ)}} \right|}{\left| {{\overrightarrow{{{x}_{{\hat{L}}}}x}}_{\hat{L},j(IJ)}}\times {{\overrightarrow{{{x}_{{\hat{L}}}}x}}_{\hat{L},i(IJ)}} \right|} 
\end{equation}
and
\begin{equation}\label{eq12aux}
 \sin \left( \theta _{\hat{L},IJ}^{1}+\theta _{\hat{L},IJ}^{2} \right)=\frac{\left| {{\overrightarrow{{{x}_{{\hat{L}}}}x}}_{\hat{L},j(IJ)}}\times {{\overrightarrow{{{x}_{{\hat{L}}}}x}}_{\hat{L},i(IJ)}} \right|}{\left| {{\overrightarrow{{{x}_{{\hat{L}}}}x}}_{\hat{L},i(IJ)}} \right|\left| {{\overrightarrow{{{x}_{{\hat{L}}}}x}}_{\hat{L},j(IJ)}} \right|}
\end{equation}
where the angles $\theta_{\hat{L},IJ}^{1}$ and $\theta_{\hat{L},IJ}^{2}$  are represented in Fig. \ref{fig1} and the symbol ``$\times$'' denotes the vector product. From Eqs. \ref{eq12} and \ref{eq12aux}, we have:
\begin{eqnarray}\label{eq13}
\left| {{\overrightarrow{{{x}_{{\hat{L}}}}x}}_{\hat{L},j(IJ)}}\times {{\overrightarrow{{{x}_{{\hat{L}}}}x}}_{\hat{L},i(IJ)}} \right|&=&\frac{\left| {{{\utilde{K}}}_{\hat{L}}^\top}{{{\vec{n}}}_{IJ}}\times {{\overrightarrow{{{x}_{{\hat{L}}}}x}}_{\hat{L},i(IJ)}} \right|}{| {{\alpha }_{\hat{L},j(IJ)}}|} \nonumber\\
&=&\left| {{\overrightarrow{{{x}_{{\hat{L}}}}x}}_{\hat{L},i(IJ)}} \right|\left| {{\overrightarrow{{{x}_{{\hat{L}}}}x}}_{\hat{L},j(IJ)}} \right|\sin \left( \theta _{\hat{L},IJ}^{1}+\theta _{\hat{L},IJ}^{2} \right)
\end{eqnarray}

We can also write:
\begin{equation}\label{eq14}
\frac{\left| {{{\utilde{K}}}_{\hat{L}}^\top}{{{\vec{n}}}_{IJ}}\times {{\overrightarrow{{{x}_{{\hat{L}}}}x}}_{\hat{L},i(IJ)}} \right|}{\left| {{{\utilde{K}}}_{\hat{L}}^\top}{{{\vec{n}}}_{IJ}} \right|\left| {{\overrightarrow{{{x}_{{\hat{L}}}}x}}_{\hat{L},i(IJ)}} \right|}=\sin \left( \theta _{\hat{L},IJ}^{1} \right)
\end{equation}

After some algebraic manipulation of Eqs. \ref{eq13} and \ref{eq14}, we get: 
\begin{equation}\label{eq15}
{\alpha }_{\hat{L},j(IJ)}=\frac{\left| {{{\utilde{K}}}_{\hat{L}}^\top}{{{\vec{n}}}_{IJ}} \right|\sin \left( \theta _{\hat{L},IJ}^{1} \right)}{\left| {{\overrightarrow{{{x}_{{\hat{L}}}}x}}_{\hat{L},j(IJ)}} \right|\sin \left( \theta _{\hat{L},IJ}^{1}+\theta _{\hat{L},IJ}^{2} \right)}
\end{equation}
where $| {{\alpha }_{\hat{L},j(IJ)}}|={{\alpha }_{\hat{L},j(IJ)}}> 0$ from the angles that satisfy the following conditions $0<\theta _{\hat{L},IJ}^{1}, \theta _{\hat{L},IJ}^{2} < \pi $ and $\theta _{\hat{L},IJ}^{1}+\theta _{\hat{L},IJ}^{2}< \pi $. Using a similar argument, we calculate the parameter ${{\alpha }_{\hat{L},i(IJ)}}$:
...
\end{equation}
where $| {{\alpha }_{\hat{L},i(IJ)}} |={{\alpha }_{\hat{L},i(IJ)}}> 0$.
...
In order to construct a conservative scheme, we use the one-side fluxes defined in Eqs.  \ref{eq19} and \ref{eq20} to determine the unique flux on the edge $IJ$. Therefore, considering flux continuity on the edge $IJ$ given in Eq. \ref{eq8}, we can write:
 \begin{equation}\label{eq20aux1}
{{\vec{\mathpzc{F}}}_{IJ}}\cdot {{\vec{N}}_{IJ}}=\vec{\mathpzc{F}}_{IJ}^{{\hat{L}}}\cdot {{\vec{N}}_{IJ}}=-\vec{\mathpzc{F}}_{IJ}^{{\hat{R}}}\cdot {{\vec{N}}_{JI}}
\end{equation}
  
On the other hand, from Eq. \ref{eq19} and replacing Eq. \ref{eq20} into \ref{eq20aux1} we get:
\begin{equation}\label{eq19aux1}
 \frac{1}{{{\psi }_{\hat{L},IJ}}}\vec{\mathpzc{F}}_{IJ}\cdot {{\vec{N}}_{IJ}}=\left| \overrightarrow{IJ} \right|\left( {{u}_{{\hat{L}}}}-\frac{1}{{{\psi }_{\hat{L},IJ}}}\sum\limits_{\gamma =i,j}{{{\alpha }_{\hat{L},\gamma (IJ)}}}{{u}_{\hat{L},\gamma (IJ)}} \right)
\end{equation}
and 
\begin{equation}\label{eq20aux2}
 \frac{1}{{{\psi }_{\hat{R},IJ}}}\vec{\mathpzc{F}}_{IJ}\cdot {{\vec{N}}_{JI}}=-\left| \overrightarrow{IJ} \right|\left( {{u}_{{\hat{R}}}}-\frac{1}{{{\psi }_{\hat{R},IJ}}}\sum\limits_{\gamma =i,j}{{{\alpha }_{\hat{R},\gamma (IJ)}}{{u}_{\hat{R},\gamma (IJ)}}} \right)
\end{equation}

Adding Eqs. \ref{eq19aux1} and \ref{eq20aux2} and after some algebraic manipulations, we obtain the unique flux on edge $IJ$, as:
\begin{equation}\label{eq21}
{{\vec{\mathpzc{F}}}_{IJ}}\cdot {{\vec{N}}_{IJ}}={{w}_{\hat{R},IJ}}\vec{\mathpzc{F}}_{IJ}^{{\hat{L}}}\cdot {{\vec{N}}_{IJ}}-{{w}_{\hat{L},IJ}}\vec{\mathpzc{F}}_{IJ}^{{\hat{R}}}\cdot {{\vec{N}}_{JI}}
\end{equation}
where the two positive weights, $w_{\hat{L},IJ}$ and $w_{\hat{R},IJ}$ are given as follows:
...
\vec{\mathpzc{F}}_{IJ}^{{}}\cdot {{\vec{N}}_{IJ}}=\vec{\mathpzc{F}}_{IJ}^{{\hat{L}}}\cdot {{\vec{N}}_{IJ}}=\left| \overrightarrow{IJ} \right|\left( {{\psi }_{\hat{L},IJ}}{{u}_{{\hat{L}}}}-\sum\limits_{\gamma =i,j}{{{\alpha }_{\hat{L},\gamma (IJ)}}{{u}_{\hat{L},\gamma (IJ)}}}\right) 
\end{equation}
...
{\color{orange}In Equation \ref{eq26}, the coefficients $\bar{\varpi }_{{\hat{i}}}$  are determined in two stages. In effect, the first stage is to build the fluxes on the half-edge $I\bar{M}_{\hat{i}}$ using the triangle $\triangle I\bar{M}_{\hat{i}}x_{\hat{i}}$ (see Fig. \ref{fig4general}), therefore:}
...
\end{equation}
{\color{orange}and the flux on the edge $\bar{M}_{\hat{i}}I$, using the triangle $\triangle x_{\hat{i}-1}\bar{M}_{\hat{i}}I$, is given by:} 
...
{\color{orange}By imposing flux continuity on the half-edge $I\bar{M}_{\hat{i}} $, we obtain the following expression:}
...
\end{equation}
{\color{orange}where  ${\eta }_{\hat{i},1}$ and ${\eta }_{\hat{i},2}$ are given by:}
...
{\color{orange}At this first stage, we have obtained $ncv$ equations for each $\bar{u}_{\hat{i}}$. Therefore, the second stage consist in eliminating all the intermediate unknowns (in this case $\bar{u}_{\hat{i}}$), then we consider a mass balance in the auxiliary region (yellow region in Fig. \ref{fig4general})}:
...
\end{equation}	
{\color{orange}where the flux $\vec{\mathpzc{F}}_{\bar{M}_{\hat{i}}\bar{M}_{\hat{i}+1}}^{{\hat{i}}}\cdot \vec{N}_{\bar{M}_{\hat{i}}\bar{M}_{\hat{i}+1}}$ on the edge $\bar{M}_{\hat{i}}\bar{M}_{\hat{i}+1}$ is derived considering the triangle $\triangle I\bar{M}_{\hat{i}}\bar{M}_{\hat{i}+1}$, so we have:}
...
\end{equation}	
{\color{orange}where  ${{\vec{N}}_{{{{\bar{M}}}_{\hat{i}}}{{{\bar{M}}}_{\hat{i}+1}}}}$ represents the area vector to the edge ${\bar{M}_{\hat{i}}}{\bar{M}_{\hat{i}+1}}$.}

{\color{orange}By substituting Eq. \ref{eqA0001} in Eq. \ref{eqA001}, we obtain the following expression:}
...
\end{equation}
{\color{orange}where for each $\hat{i}=1,2,...,ncv$, we have:}
...
\end{equation}
{\color{orange}By substituting Eq. \ref{eqA0} into \ref{eqA01}, we get:}
...
\end{equation}
{\color{orange}here $\zeta=\hat{i}+k-1$ and $k=1,2$.}

{\color{orange}The physical-geometric parameters $\overline{K}_{{\hat{i}}}^{\left( n \right)}$, $\overline{K}_{{\hat{i}}}^{\left( t \right)}$, $K_{\hat{i},k}^{(n)},\,\,K_{\hat{i},k}^{(t)}$ and $\xi\left( {\hat{i}} \right)$ are computed during the preprocessing stage. Further details of the LPEW interpolation can be found in (\cite{gao2011linearity}, \cite{queiroz2014accuracy}, \cite{contreras2016cell}).}
