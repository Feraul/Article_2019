...
\begin{table}[!ht]
	...
	%\vspace{-20pt}
	\centering
	\caption{Linearity test}
	\begin{subtable}{1\textwidth}
		
		\begin{tabular}{c c c c c| c c c c }
			\hline
			&  \multicolumn{4}{c}{ Picard Iteration}
			&  \multicolumn{4}{|c}{  Anderson Accelerator}\\
			\cline{1-9}
			&  $\varepsilon_{u}$ &  $\varepsilon_{\mathpzc{F}}$ & Iter. Number&CPU& $\varepsilon_{u}$ & $\varepsilon_{\mathpzc{F}}$& Iter. Number &CPU\\
			\hline  
			&9.89e-12 &5.65e-11& 13 &0.75 &5.73e-12  &3.92e-11 & 2&0.64 \\	
			\hline
		\end{tabular}
	\end{subtable}
...
According to Herbin and Hubert \cite{herbin2008benchmark}, this problem represents a situation encountered in underground flow engineering where an oblique drain consisting in a very permeable layer concentrates most part of the flow. This drain is meshed with only one layer of cells, see Fig. \ref{fig:fig4b}. We discretize the domain using an oblique mesh (see Fig. \ref{fig:fig4a}), and we have obtained the errors showed in Table \ref{tab11},  showing that the NLFV-PP scheme is linearity-preserving.
...
\begin{figure}
	...
	\begin{subfigure}[b]{0.3\textwidth}
		...
		\label{fig:fig4c}
	\end{subfigure}
	\caption{(a) Oblique mesh, (b) discontinuous diffusion tensor (blue region stands for $\Omega_{1}\cap\Omega_{3}$  and red region stands for $\Omega_{2}$) and (c) the exact solution.}
	\label{fig:fig4}
\end{figure}
...
\begin{table}[!ht]
	...
	\begin{tabular}{c c c c  | c c | c c  }
		...
		&   & PI& AA  & PI &  AA& PI&  AA \\
		\hline  
		& $u_{max}$ &2.19 & 2.18      &2.44   &2.44 & 2.17&2.17\\
		& $u_{min}$ &1.87e-13 &1.85e-13     &2.11e-21      &2.11e-21 &6.89e-30&6.89e-30\\
		& Iter. Number&1000   &2      &1000      &6 &1000 &5 \\
	    & CPU  &61.99     &3.52      &268.03      &14.35 &976.40 &66.12 \\	
		\hline
	\end{tabular}
	\label{tab6}
\end{table}
